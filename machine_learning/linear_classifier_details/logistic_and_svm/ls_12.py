...
Hint
Create a logistic regression object with C=100 and the default settings for other hyperparameters.
Then, pass this object, named lr_class_1, into plot_classifier.
