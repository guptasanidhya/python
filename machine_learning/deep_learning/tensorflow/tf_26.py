from tensorflow import matmul,reduce_sum,reshape,constant
...
Hint
Use the reshape() operation and remember that its second argument is the post-transformation shape of the tensor.
Use matmul() to perform matrix multiplication.
Recall that reduce_sum() can be used to sum over the elements of a tensor.
Apply .numpy() to prediction and pass it as an argument to print().
"""