...
for j in range(10):
    ...
    print(params[0].numpy(),params[1].numpy(),params[2].numpy())
...
Hint
Recall that the predicted values are computed as params[0] + feature1*params[1] + feature2*params[2].
loss_function() should take params as an argument.
The keras.losses.mae() operation computes the mean absolute error.
Pass params to loss_function() and the variables list.
"""