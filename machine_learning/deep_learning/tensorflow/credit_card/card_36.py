...
Hint
Pass borrower_features and float32 to constant().
Use keras.layers.Dense() and recall that the first argument should be the number of nodes.
Use keras.layers.Dense() with the first argument equal to 8 and the activation parameter set to relu.
Remember that multiclass problems should use softmax in the output layer.
"""
