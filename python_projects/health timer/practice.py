...
water_alarm = 20 # seconds
eyes_alarm = 30 # seconds
physical_alarm = 45 # seconds


# non-costimizable variables
ex = True
d = datetime.datetime.now()
water_timer = d.second + water_alarm
eyes_timer = d.second + eyes_alarm
physical_timer = d.second + physical_alarm
...
while ex!= False:
    ...
    if water_timer >= 60 or eyes_timer >= 60 or physical_timer >= 60:
        ...
        if new_d.second == physical_timer and new_d.second == water_timer:
        ...
        elif new_d.second == physical_timer and new_d.second == eyes_timer:
        ...
        elif new_d.second == water_timer and new_d.second == eyes_timer:
        ...
        elif new_d.second == physical_timer:
