...
#same as part 4 only the init method is added
#################################################################################################################
    def __init__(self,**kwargs):
        super(PDF,self).__init__(**kwargs)
        #adding fonts
        self.add_font('Agency', '', 'C:\Windows\Fonts\AGENCYR.ttf')  # trueType font subset embedding

        # google fonts
        self.add_font('oswald', 'B', r"E:\study\Extra\python\python_projects\pdf designer\Oswald-Bold.ttf")
        self.add_font('oswald', '', r"E:\study\Extra\python\python_projects\pdf designer\Oswald-Regular.ttf")
###################################################################################################################
    def header(self):
        # font
        self.set_font('oswald', 'B', 15)
        ...
        # Title
        self.cell(title_w, 10, title, border=1, ln=1, align='C', fill=True)
        # Line break
        self.ln(10)
    ...
    def chapter_title(self, ch_num, ch_title, link):
        ...
        self.set_link(link)
        # set font
        self.set_font('Agency', '', 12)
        # background color
        self.set_fill_color(200, 220, 255)
        # Chapter title
        chapter_title = f'Chapter {ch_num} : {ch_title}'
        self.cell(0, 5, chapter_title, ln=1, fill=True)
        # line break
        self.ln()
